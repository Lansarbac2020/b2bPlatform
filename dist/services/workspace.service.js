...
exports.deleteWorkspaceService = exports.updateWorkspaceByIdService = exports.changeMemberService = exports.getWorkspaceAnalyticsService = exports.getWorkspaceMembersService = exports.getWorkspaceByIdService = exports.getAllWorkspaceUserService = exports.createWorkspaceService = void 0;
...
// GET ALL WORKSPACE
//**************** **************/
const getAllWorkspaceUserService = async (userId) => {
...
exports.getAllWorkspaceUserService = getAllWorkspaceUserService;
//****************************************************************
...
const changeMemberService = async (workspaceId, memberId, roleId) => {
    const workspace = await workspace_model_1.default.findById(workspaceId);
    if (!workspace) {
        throw new appError_1.NotFoundException("Workspace not found");
    }
...
exports.changeMemberService = changeMemberService;

...
exports.deleteProjectService = exports.updateProjectService = exports.getProjectAnalyticsService = exports.getProjectByIdAndWorkspaceIdService = exports.getAllProjectsService = exports.createProjectService = void 0;
...
const getAllProjectsService = async (workspaceId, pageSize, pageNumber) => {
    ...
    const totalCount = await project_model_1.default.countDocuments({ workspace: workspaceId });
    const skip = (pageNumber - 1) * pageSize;
    const projects = await project_model_1.default.find({ workspace: workspaceId }).skip(skip).limit(pageSize)

...
workspaceRoutes.put("/change/member/role/:id", workspace_controller_1.changeMemberRoleController);
workspaceRoutes.delete("/delete/:id", workspace_controller_1.deleteWorkspaceByIdController);
workspaceRoutes.get("/all", workspace_controller_1.getUserMemberWorkspaceController);

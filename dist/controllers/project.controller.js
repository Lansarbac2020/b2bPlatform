...
exports.deleteProjectController = exports.updateProjectController = exports.getProjectAnalyticsController = exports.getProjectsByIdAndWorkspaceController = exports.getAllProjectsController = exports.createProjectController = void 0;
...
exports.getAllProjectsController = (0, asyncHandler_middleware_1.asyncHandler)(async (req, res) => {
    ...
    const { projects, totalCount, totalPages, skip } = await (0, project_service_1.getAllProjectsService)(workspaceId, pageSize, pageNumber);
    return res.status(http_config_1.HTTPSTATUS.OK).json({
...
exports.getProjectsByIdAndWorkspaceController = (0, asyncHandler_middleware_1.asyncHandler)(async (req, res) => {

...
exports.deleteWorkspaceByIdController = exports.updateWorkspaceByIdController = exports.changeMemberRoleController = exports.getWorkspaceAnalyticsController = exports.getWorkspaceMembersController = exports.getWorkspaceByIdController = exports.getUserMemberWorkspaceController = exports.createWorkspaceController = void 0;
...
exports.getUserMemberWorkspaceController = (0, asyncHandler_middleware_1.asyncHandler)(async (req, res) => {
    const userId = req.user?._id;
    const { workspaces } = await (0, workspace_service_1.getAllWorkspaceUserService)(userId);
...
exports.changeMemberRoleController = (0, asyncHandler_middleware_1.asyncHandler)(async (req, res) => {
    const workspaceId = workspace_validation_1.workspaceIdSchema.parse(req.params.id);
    ...
    const { member } = await (0, workspace_service_1.changeMemberService)(workspaceId, memberId, roleId);
    return res.status(http_config_1.HTTPSTATUS.OK).json({

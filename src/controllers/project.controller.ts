...
import { createProjectService, deleteProjectService, getAllProjectsService, getProjectAnalyticsService, getProjectByIdAndWorkspaceIdService, updateProjectService } from "../services/project.service";
...
export const getAllProjectsController=asyncHandler(
    async (req: Request, res: Response) => {
        ...
        const {projects, totalCount, totalPages, skip}= await getAllProjectsService(
            workspaceId,
            pageSize,
            pageNumber
        );
...
export const getProjectsByIdAndWorkspaceController=asyncHandler(
    async (req: Request, res: Response) => {
